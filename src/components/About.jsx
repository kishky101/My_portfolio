    ...
    <>
      ...
      <div>
        ...
        >
          ...
          As a dedicated Full-stack Developer, I bring a passion for crafting
          seamless user experiences. Proficient in HTML, CSS, and JavaScript, I
          thrive on transforming ideas into visually stunning and interactive
          realities. Let me elevate your projects to new heights with
          innovation, precision, and a keen eye for detail. Together, let&apos;s
          create digital wonders that leave a lasting impact.
        </motion.p>
        ...
        <div
          className="fixed bottom-[100px] right-[-10px] z-[100] flex-col flex items-center justify-center gap-5 px-3 py-5 rounded-l"
          style={theme === "dark" ? darkLinkStyle : lightLinkStyle}
        >
